...
DEFAULT_CONFIG = {
    ...
    "discord": {
        ...
        # Native Discord VC ↔ OpenAI Realtime voice proxy. Discord remains the
        # phone client; every recognized turn is delegated back into the full
        # Hermes session via a required consult_hermes function call. Secrets
